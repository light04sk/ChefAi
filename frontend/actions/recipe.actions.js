...
async function fetchRecipeImage(recipeName) {
  try {
    ...
    // ✅ Removed redundant template literal — just use the variable directly
...
export async function getRecipesByPantryIngredients() {
  try {
    ...
    // ✅ Sanitize ingredient names before injecting into the AI prompt
    // Strips special characters that could be used for prompt injection
